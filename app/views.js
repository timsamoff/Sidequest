...
export function linksSection(root, p) {
  ...
  links.forEach(function (lp) {
    ...
    if (!readOnly) {
      ...
      var lc = el("button", { type: "button", "class": "small" + (lp.launchCritical ? " on" : ""), "aria-pressed": lp.launchCritical ? "true" : "false", title: (lp.launchCritical ? "Unmark as" : "Mark as") + " launch critical" }, lp.launchCritical ? "Unset launch critical" : "Mark launch critical");

...
- **Parking lot:** a dedicated page for loose ideas and waiting items that are not competing for the next project slot. Edit an idea's text and multiline note any time, or turn it into a project candidate.
